...
## Installation 
The casso package can be installed directly from GitHub using devtools with the following command in R console:
`install_github("Syksy/casso")`

Direct URL to the latest source code of the package is available publicly on GitHub at: https://github.com/Syksy/casso
...
Now `tmp` is a casso object that contains the relevant S4-object slots, such as the model coefficients and target function values. The casso object "tmp" can be used further to, for example, plot and predict. We visualize the target function value with the `visu` function:
```{r eval=FALSE}
visu(tmp)
```

```{r echo=FALSE, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Figure caption"}
include_graphics("images/tmp_visu.png")
```
...
```{r echo=FALSE, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Figure caption"}
include_graphics("images/tmp_cv_visu.png")
```
...
```{r echo=FALSE, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Figure caption"}
include_graphics("images/tmp_bs_visu.png")
```
...
```{r echo=FALSE, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Figure caption"}
include_graphics("images\tmp_kmax10_visu.png")
```
